...
PIN = "c54763752e01ecbe0702c2e055fd69b70ad2d8e94979d74be2bd4b04ec1d9631"
...
class MovableFlashlightTests(unittest.TestCase):
    ...
    def test_sign_means_pixel_intensity_change(self) -> None:
        ...
        last = np.array([[12.0, 17.0]])
        net_signed = last - first
        self.assertGreater(net_signed[0, 0], 0)
        self.assertLess(net_signed[0, 1], 0)
